...
describe("ChallengeComponent - Functional Tests", () => {
  ...
  describe("Initial State", () => {
    ...
    it("displays initial tasks in correct columns", () => {
      expectTaskInColumn("Mow The lawn", "To Do");
      expectTaskInColumn("Pull Weeds", "In Progress");
      expectTaskInColumn("Rake the leaves", "Done");
    });

    it("shows correct button states for initial tasks", () => {
      // To Do task should have left button disabled
      const todoTask = getTaskElement("Mow The lawn");
      ...
      const doneTask = getTaskElement("Rake the leaves");
  ...
  describe("Task Movement Functionality", () => {
    it("moves task from Todo to In Progress when clicking right arrow", () => {
      clickTaskButton("Mow The lawn", "right");
      
      expectTaskInColumn("Mow The lawn", "In Progress");
      expectTaskNotInColumn("Mow The lawn", "To Do");
    });

    it("moves task from In Progress to Done when clicking right arrow", () => {
      clickTaskButton("Pull Weeds", "right");
      
      expectTaskInColumn("Pull Weeds", "Done");
      expectTaskNotInColumn("Pull Weeds", "In Progress");
    });

    it("moves task from Done to In Progress when clicking left arrow", () => {
      clickTaskButton("Rake the leaves", "left");
      
      expectTaskInColumn("Rake the leaves", "In Progress");
      expectTaskNotInColumn("Rake the leaves", "Done");
    });

    it("moves task from In Progress to Todo when clicking left arrow", () => {
      clickTaskButton("Pull Weeds", "left");
      
      expectTaskInColumn("Pull Weeds", "To Do");
      expectTaskNotInColumn("Pull Weeds", "In Progress");
    });
  ...
  describe("Add Task Functionality", () => {
    ...
    it("does not add empty task when form is submitted", () => {
      ...
      const allTasks = screen.getAllByText(/Mow The lawn|Pull Weeds|Rake the leaves/);
  ...
  describe("Edge Cases", () => {
    it("handles rapid task movements correctly", () => {
      ...
      expectTaskInColumn("Mow The lawn", "Done");
    });
    ...
    it("maintains task order when multiple tasks are in same column", () => {
      ...
      expect(tasks).toMatch(/Mow The lawn.*Task 1.*Task 2/);
    });
  });
});
